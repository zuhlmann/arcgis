...
subproject = 'aquatics_spherical_video'
...
# # Z) Create reference ReSource for multiple aprx
csv_aprx=r"C:\Box\MCMGIS\Project_Based\South_Fork_Tolt\map_documents\aprx_inventories\SFT_aprx_inv_devel.csv"
csv_lyR_all=r"C:\Box\MCMGIS\Project_Based\South_Fork_Tolt\map_documents\aprx_inventories\SFT_all_lyR_inv.csv"
# pro_obj.aprx_map_inv(csv_aprx, csv_lyR_all)
import utilities_oop
utils_obj = utilities_oop.utilities('aaah', 'eeeh')
csv_out=r'C:\Box\MCMGIS\Project_Based\South_Fork_Tolt\map_documents\aprx_inventories\temp.csv'
pro_obj.concatenate_aggregate(csv_lyR_all, csv_out, 'APRX', 'DATA_LOCATION_MCMILLEN','MAP_NAME')
