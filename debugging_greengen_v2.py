...
# # March 2025: Join old maestro to newly generated maestro (i.e. v2_0)
csv_temp=r"C:\Users\UhlmannZachary\Documents\fuck.csv"
# csv_orig=r"C:\Users\uhlmann\postgres_offline\SFT\SFT_lyR_deliverable_inv2_v3_0_orig.csv"
# df_lyR_maestro=pd.read_csv(fp_lyR_inv_maestro, index_col='DATA_LOCATION_MCMILLEN')
# df_lyR_maestro_orig=pd.read_csv(csv_orig, index_col='DATA_LOCATION_MCMILLEN')
# mask=df_lyR_maestro_orig[~pd.isnull(df_lyR_maestro_orig[['DATA_LOCATION_MCM_RESOURCE', 'ACTION']]).all(1)]
# cols=['DATA_LOCATION_MCM_RESOURCE','ACTION','PSP_2024','PSP_2024_2']
# subset=df_lyR_maestro_orig.loc[mask.index,cols]
# df_merged = df_lyR_maestro.merge(subset, left_index=True, right_index=True, how='outer')
...
# action=['copy']
# df2 = pro_obj.df_to_df_transfer_v2(df1, df2, 'ACTION', 'rename_master', tc1, tc2, mc_dict, False)
# df2.to_csv(fp_lyR_inv_maestro)

# # # # B1) Transfer Action from df_lyr_maestro to df_LYr GREENGEN!!
...
# df = pro_obj.flag_csString_val('df_lyR_maestro', 'APRX', 'PSP_2024', 'PSP_2024')
# df.to_csv(fp_lyR_inv_maestro)
...
df_lyR_maestro=pd.read_csv(fp_lyR_inv_maestro, index_col='DATA_LOCATION_MCMILLEN')
subset=df_lyR_maestro['PSP_2024']
