...
# Other layers used
fp_IG_18_OpenTopo_3m = os.path.join(fp_box_offline_d, 'Bathymetry_OpenTopography_2018/rasters_sdem/IronGate_2018_3m.tif')
fp_IG_10_2m = os.path.join(fp_box_offline_d, 'bathymetry_project/Bathy_2ft_IronGate.tif')
