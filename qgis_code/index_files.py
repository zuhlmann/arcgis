...
# relative=False
# # !!!!! If converting to meters, just reverse engineer relative scale and use that.
# # !!!!! i.e. 1in = 300ft = 12*300 - 1:3600
# ft_to_in_scale = 91
# relative_scale = 3600
...
# fp_out = r'C:\Box\MCMGIS\Project_Based\Blind_Slough\data\vector\staging\blind_slough_idx_1in300ft_MERCATOR.shp'
# gdr.to_file(fp_out)

# load df
fp_shp = r"C:\Box\MCMGIS\Project_Based\Blind_Slough\data\vector\staging\blind_slough_idx_1in800_MERCATORft.shp"
...
fp_out=r"C:\Box\MCMGIS\Project_Based\Blind_Slough\data\vector\staging\blind_slough_inundation_3ref_pts.shp"
gdr.to_file(fp_out)
