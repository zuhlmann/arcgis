# import processing
shp = r'C:\Box\MCM Projects\MCWRA (Monterey County)\25-001_San Antonio Spillway Design\6.0 Plans and Specs\6.4 Design\6.4.4 Hydraulics\2025 PMF update\NLCD_2025\zonal_hist.shp'

# params = {'INPUT_RASTER':'Annual_NLCD_LndCov_2023',
#             'RASTER_BAND':1,
#             'INPUT_VECTOR':'subbasins_fixed',
#             'COLUMN_PREFIX':'HISTO_',shp
#             'OUTPUT':
#             }
...
# import pandas as pd
# csv_legend = r"C:\Users\ZacharyUhlmann\Downloads\NLCD_tJfNHo902Le2GMhaVeYs\NLCD_landcover_legend_2018_12_17_tJfNHo902Le2GMhaVeYs.csv"
...
# shp_out = r'C:\Box\MCM Projects\MCWRA (Monterey County)\25-001_San Antonio Spillway Design\6.0 Plans and Specs\6.4 Design\6.4.4 Hydraulics\2025 PMF update\NLCD_2025\zonal_hist_fmt.shp'
