...
file_out = r'E:\projects\potter_valley\data_check\To_Be_Filed\CapeHornPP_2020 - Standard\CapeHornPP_Eel_2020_xyz.tif'
...
# nrows = len(df)
# with open(r'E:\projects\potter_valley\data_check\To_Be_Filed\CapeHornPP_2020 - Standard\CapeHornPP_Eel_2020_xyz_summary.txt','w') as txt_file:
#     stats_str = f"xmin: {xmin}\nxmax: {xmax}\nymin: {ymin}\nymax: {ymax}\nnumber of rows: {nrows}"
#     txt_file.write(stats_str)
# df.to_csv(r"E:\projects\potter_valley\data_check\To_Be_Filed\CapeHornPP_2020 - Standard\CapeHornPP_Eel_2020_xyz.csv")
