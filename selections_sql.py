...
cursor = arcpy.da.InsertCursor(copy.copy(path_working), ['SHAPE@'])
cursor.insertRow([polygon])

# Delete cursor object
del cursor

arcpy.CreateFeatureclass_management(copy.copy(path_working),  'polygon_practice', 'Polygon')

for row in arcpy.da.SearchCursor(os.path.join(copy.copy(path_working), 'polygon_practice'), ["shape@x"]):
    print(row)
